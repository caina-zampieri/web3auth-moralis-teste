import { useWeb3Auth, useWeb3AuthSave } from "../services/web3auth";
import styles from "../styles/Home.module.css";


const Main = () => {
  const { save } = useWeb3AuthSave();
  ...
  const loggedInView = (
    <>
      ...
      <button onClick={useWeb3AuthSave} className={styles.card}>
        salvar dados na moralis
      </button>
